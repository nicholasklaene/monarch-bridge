package com.nicholasklaene.monarchproxy

import com.nicholasklaene.monarchproxy.exceptions.MonarchMfaRequiredException
import com.nicholasklaene.monarchproxy.services.MonarchAuth
 ...
 *   ./gradlew :api:bootstrapMonarch --args="--mfa-secret=BASE32SECRET"
 *
...
object MonarchBootstrapMain {
    ...
    fun main(args: Array<String>) {
        ...
        try {
            ...
            println("Start the service with: ./gradlew :api:bootRun")
        } finally {
            ctx.close()
        }
    }
    ...
    private fun printHelp() {
        println(
            ...
            Usage:
              ./gradlew :api:bootstrapMonarch
              ./gradlew :api:bootstrapMonarch --args="--mfa-secret=<BASE32_SEED>"
            ...
            (default: ~/.config/monarch-proxy/.mm-session.json).
            """.trimIndent(),
        )
    }
