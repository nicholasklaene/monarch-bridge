...
import com.nicholasklaene.monarchproxy.config.MonarchProperties
import com.nicholasklaene.monarchproxy.exceptions.MonarchMfaRequiredException
import com.nicholasklaene.monarchproxy.exceptions.MonarchRequestFailedException
 ...
 *
 * IMPORTANT: The payload shapes tested here are based on upstream monarchmoneycommunity source
 * (bradleyseanf/monarchmoneycommunity@befdadc7163f90053be5820346f3095b78c7a857).
 *
 * All fixture shapes are pinned to our assumptions and reconciled at first real bootstrap.
 * See ticket: monarch-auth-payload-verify
 *
 * // VERIFY-AT-BOOTSTRAP: response body shape {token, tokenExpiration} matches Monarch /auth/login/.
 * // VERIFY-AT-BOOTSTRAP: HTTP 403 is the correct MFA-required signal.
 * // VERIFY-AT-BOOTSTRAP: successful login returns HTTP 200 with {token: "...", tokenExpiration: null}.
 */
